...
::============================================================================
::
::   This script is a part of 'Microsoft_Activation_Scripts'.
::
...
cls
color 07
title  Microsoft_Activation_Scripts by Morn chaipor %masver%
...
echo 
%eline%
echo You are running outdated version Activator %masver%
echo:         
if not defined _MASunattended (
echo [x] Download Latest Win activate by morn chaipor 
echo:
echo [0] Continue Anyway
echo:
echo:
echo: if you download on low version, No worry!!!!! this script work fine . 
echo:
echo:
call :_color %_Green% "Enter a menu option in the Keyboard [0] :"
choice /C:10 /N
if !errorlevel!==2 rem
...
cls
color 07
title  Microsoft_Activation_Scripts activator %masver%
mode 76, 30
...
echo:                                   Activation
echo:
echo:             Service            TYPE                            Lifetime
echo:            [1] HWID        ^|  Windows                      ^|  Permanent
echo:            [2] Ohook       ^|  Office-Only / excel / word   ^|  Permanent
...
echo:
echo                           Just press the number pad
echo:
